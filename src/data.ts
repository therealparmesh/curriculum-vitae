export default {
  profile: {
    ...
    social: {
      linkedin: {
        name: 'therealparmesh',
        link: 'https://www.linkedin.com/in/therealparmesh',
      },
      github: {
        name: 'therealparmesh',
        link: 'https://github.com/therealparmesh',
      },
    },
  },
  summary: `
    ...
    These days, I am focused on all aspects of UI development - including but not limited to React, TypeScript, frontend libraries, micro frontends, and GraphQL.
  `,
  experiences: [
    {
      company: 'CS Disco',
    ...
    },
    {
      ...
      period: 'AUG 2015 – DEC 2016 (side job)',
      descriptions: [
        'Recruited by the leadership of the company to help lead their new project',
        'Proposed the solution to achieve Section 508 accessibility standards compliance as required by government customers',
      ],
    },
    {
      company: 'GHG Corporation',
      ...
      descriptions: [
        ...
        'Helped to implement the new REST API',
      ],
    },
    {
      company: 'The US Department of Defense',
      location: 'Fort Meade, MD',
      title: 'Intern',
      period: 'AUG 2007 – DEC 2009 (mainly summers)',
      descriptions: [
        'Given a scholarship for undergraduate studies',
        'Completed given software development lessons and tasks',
      ],
    },
  ],
  educations: [
    ...
    },
    {
      ...
      city: 'Houston, TX',
      period: '2012',
      descriptions: ['Associate Java programmer'],
    },
  ],
  skills: [
    'JavaScript',
  ...
  miscellany: [
    'Skipped a grade and started college with a scholarship and an internship at age 16',
    'Swam competitively and earned the Michael Poor Sportsmanship Award from the community',
    'Studied French and learned to play the guitar and the flute',
  ],
};
